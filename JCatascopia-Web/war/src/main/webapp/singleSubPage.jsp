	...
	<div class="column" id="right_col">
		<div class="infocontainer" align="center">
			...
			<div class='infowrapper' align="left">
				<table class="staticinfo_table">
					<tr>
						<td class="staticinfo" id="subName"><span class="staticinfo_label">Subscription Name</span></td>
						<td class="staticinfo" id="group"><span class="staticinfo_label">Group</span></td>
					</tr>
					<tr>
						<td class="staticinfo" id="func"><span class="staticinfo_label">Function</span></td>
						<td class="staticinfo" id="metricType"><span class="staticinfo_label">Metric Type</span></td>
					</tr>
					<tr>
						<td class="staticinfo" id="period"><span class="staticinfo_label">Period</span></td>
						<td class="staticinfo" id="metricUnits"><span class="staticinfo_label">Metric Units</span></td>
					</tr>
				</table>
			</div>
		</div>
		...
		<div class="container" id="subscription" align="center">
			...
			<div class="wrapper" id="subscriptionWrap" style="display: block;">
				<canvas width="800" height="290" id="subscriptionGraph" style="cursor: default;">[No canvas supported]</canvas>
			</div>
		</div>
	</div>
</body>
