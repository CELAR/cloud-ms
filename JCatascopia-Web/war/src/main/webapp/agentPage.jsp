...
<head>
	...
	<script type="text/javascript" src="js/agentPage.js"></script>
	...
	<!-- stylesheets -->
	<link rel="stylesheet" style="text/css" href="css/agentPage.css" />
...
<body>
	<section class="block border" id="subList">
		<div class="header" align="center" id="agentsHeader"><span class="expand">-</span>My Agents</div>
		<div id="agentsContent" class="content">
