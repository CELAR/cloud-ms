		...
		<div class="infocontainer" align="center">
			...
			<div class='infowrapper' align="left">
				<table class="staticinfo_table">
					<tr>
						<td class="staticinfo" id="os"><span class="staticinfo_label">Operating System</span></td>
						<td class="staticinfo" id="cpuNum"><span class="staticinfo_label">CPU Number</span></td>
					</tr>
					<tr>
						<td class="staticinfo" id="arch"><span class="staticinfo_label">Architecture</span></td>
						<td class="staticinfo" id="memTotal"><span class="staticinfo_label">Total Memory</span></td>
					</tr>
					<tr>
						<td class="staticinfo" id="btime"><span class="staticinfo_label">Boot Time</span></td>
						<td class="staticinfo" id="diskTotal"><span class="staticinfo_label">Total Disk</span></td>
					</tr>
				</table>
			</div>
		</div>
...
<div id="statusbar" class="fixed" style="clear: both; background-color:#ddd; bottom: 0px; width:95%; display: none;" >
	<table>
		<tr>
			<td style="font-weight: bold;">AgentID:</td><td><%= request.getParameter("agentID")%></td><td class=".st_sep"></td>
			<td style="font-weight: bold;">AgentIP:</td><td><%= request.getParameter("agentIP")%></td><td class=".st_sep"></td>
			<td style="width:80%;text-align:right; font-weight: bold;">Time:</td><td id="clockid" ></td>
		</tr>
	</table>
</div><!-- statusbar -->
<div id="statusbar" class="secondary active" style="clear: both; background-color:#ddd; bottom: 0px; width:100%;" >
	<table>
		<tr>
			<td style="font-weight: bold;">AgentID:</td><td><%= request.getParameter("agentID")%></td><td class=".st_sep"></td>
			<td style="font-weight: bold;">AgentIP:</td><td><%= request.getParameter("agentIP")%></td><td class=".st_sep"></td>
